...
namespace Otamix1.Controllers
{
    public class MensagemsController : Controller
    {
        ...
        public MensagemsController(Otamix1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TItulo,Descricao,DataMensagem,Categoria")] Mensagem mensagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TItulo,Descricao,DataMensagem,Categoria")] Mensagem mensagem)
        {
            if (id != mensagem.Id)
            {
                return NotFound();
